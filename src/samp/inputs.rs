...
impl Input {
    pub fn get<'a>() -> Option<&'a mut Input> {
        let input_addr = match version() {
            ...
            Version::V038 => super::v038::CINPUT,
            _ => return None,
        };
...
impl Dialog {
    pub fn get<'a>() -> Option<&'a Dialog> {
        let dialog_addr = match version() {
            ...
            Version::V038 => super::v038::CDIALOG,
            _ => return None,
        };
...
pub fn show_cursor(show: bool) {
    ...
    unsafe {
        ...
        let setcursor_addr = match version() {
            ...
            Version::V038 => super::v038::CGAME_SETCURSORMODE,
            _ => return,
        };
        ...
        let process_addr = match version() {
            ...
            Version::V038 => super::v038::CGAME_PROCESSINPUTENABLING,
            _ => return,
        };
